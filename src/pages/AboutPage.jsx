      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <Card className="mb-8">
          ...
          <div className="space-y-4">
                  <div className="border-l-4 border-brand-600 pl-4 py-2 mb-4 bg-brand-600/10 dark:bg-brand-600/20">
          ...
          <div className="mt-6">
            <a
              href="https://github.com/kubaliski/quiz_app"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
            >
              ...
              <span className="text-white">Ver repositorio en GitHub</span>
            </a>
          </div>
        </Card>
        ...
        <Card>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-200">
            ...
            <li>Envía un correo a <a href="mailto:angel.ccapb@gmail.com" className="text-brand-600 dark:text-brand-400 hover:text-brand-800 dark:hover:text-brand-300">angel.ccapb@gmail.com</a></li>
